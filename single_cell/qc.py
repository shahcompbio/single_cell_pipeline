...
def qc_workflow(args):
    ...
    grouplevel_high_impact_mafs = {patient: os.path.join(out_dir, patient, "grouplevel_high_impact_maf.maf") 
        for patient in patients
    }
    ...
    alignment_metrics_files = {label:paths["alignment_metrics"] for label, paths in data.items()}
    ...
    sample_level_maf = {label:os.path.join(out_dir, *label,  "samplelevelmaf.maf") for label, paths in data.items()}
    ...
    workflow.subworkflow(
        ...
        args=(
            ...
            mgd.InputFile('mappability', 'patient', 'sample_id', 'library_id', fnames=mappability_files),
            ...
            mgd.InputFile('cosmic_status', 'patient', 'sample_id', 'library_id', fnames=cosmic_status_files),
            ...
            mgd.InputFile('alignment_metrics', 'patient', 'sample_id', 'library_id', fnames=alignment_metrics_files),
    ...
    workflow.subworkflow(
        ...
        args=(
            ...
            mgd.InputFile("snvs_all", "patient", "sample_id", "library_id", fnames=snvs_all, axes_origin=[]),
