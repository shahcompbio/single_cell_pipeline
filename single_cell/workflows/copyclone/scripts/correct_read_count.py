...
class CorrectReadCount(object):
    ...
    def __init__(self, gc, mapp, wig, output, mappability=0.9,
                 ...
                 polynomial_degree=2, sample_id=None):
        ...
        self.wig = wig
        self.output = output
        self.sample_id = sample_id if sample_id else "NA"
    ...
    def modal_quantile_regression(self, df_regression, lowess_frac=0.2):
        ...
        distances = poly2_quantile_integration[
            1:] - poly2_quantile_integration[:-1]

        df_dist = pd.DataFrame({'quantiles': quantiles,
