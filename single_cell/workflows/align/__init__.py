...
def bam_metrics_workflow(
    ...
    workflow.transform(
        ...
        axes=('cell_id',),
        args=(
            mgd.InputFile('sorted_markdups', 'cell_id', fnames=bam_filename, extension=['.bai']),
...
def create_alignment_workflow(
    ...
    workflow.transform(
        ...
        args=(
            ...
            mgd.OutputFile('sorted_markdups_mt', 'cell_id', fnames=mt_bam_filename, extensions=['.bai']),
